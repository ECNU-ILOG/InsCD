...
class XES3G5M(DataHubBase):
    def __init__(self, root: str = "./tmp", **kwargs):
        super().__init__(**kwargs)
        # download XES3G5M Geology dataset from Google driver
        url = "https://drive.google.com/uc?id=1yX3irjviVFV0Rq4i4FQP4JgelBV8FUJ4"
        filename = "XES3G5M_data.zip"
